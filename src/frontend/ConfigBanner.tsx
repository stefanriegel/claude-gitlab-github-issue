...
export const ConfigBanner: React.FC<Props> = ({ onOpenSettings }) => (
  <div className="cgi-config-banner">
    ...
    <p style={{ opacity: 0.65 }}>
      Connect this project to a GitHub repository to start managing issues as a kanban board.
    </p>
    <button
      className="cgi-btn"
    ...
    <p style={{ fontSize: 11, opacity: 0.45, marginTop: 8 }}>
      You'll need a GitHub personal access token with <code style={{ background: 'rgba(0,0,0,0.1)', padding: '1px 4px', borderRadius: 3 }}>repo</code> scope.<br />
